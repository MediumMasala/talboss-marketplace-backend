-- Redefine the marketplace count to include "maybes":
--   classifier said yes (is_marketplace=true) OR
--   classifier was uncertain (confidence in 'low','medium').
-- High-confidence rejections are excluded.
